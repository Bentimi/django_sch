...
class aspirants_profile(models.Model):
    ...
    phone_no = models.CharField(unique=True, max_length=25)
    ...
    create_time = models.DateField(auto_now_add=True, unique=False, null=True)
...
class admission_approval(models.Model):
    ...
    approved_time = models.DateField(auto_now_add=True, unique=False, null=True)